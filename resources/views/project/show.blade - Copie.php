<section id="cd-intro" style="margin-bottom: 50px; margin-top: -20px; z-index: 0; ">
	<div id="cd-intro-background"><img src="{{ asset('uploads/app/images/project/') . '/' }}<% projects[0].url_image_title %>" /></div>
	<div id="cd-intro-tagline">
		<h1>Zoom-out Intro Effect</h1>
	</div> <!-- cd-intro-tagline -->
</section> <!-- #cd-intro -->

<!--<ng-project-nav test="projects[0].content"></ng-project-nav>-->
{{--
	<section id="cd-intro" style="margin-bottom: 50px; margin-top: -20px; z-index: 0; ">
		<div id="cd-intro-background"><img src="{{ asset('uploads/app/images/project/') . '/' }}<% projects[0].url_image_title %>" /></div>
		<div id="cd-intro-tagline">
